          ...
          >
            <div className="p-6 rounded-2xl gradient-navy text-white shadow-luxury">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-gold text-xs tracking-[0.25em] uppercase">Campus Address</div>
                  <div className="mt-1 font-serif text-base leading-snug">
                    Gangali, Chhutmalpur, Saharanpur, U.P. – 247662
                  </div>
                  <a
                    href="https://goo.gl/maps/BNjk9TqhZaYbnhPH8"
                    target="_blank"
                    rel="noreferrer"
            ...
            <div className="rounded-2xl overflow-hidden border border-border shadow-glass h-[300px] w-full">
              <iframe
                ...
                src="https://www.google.com/maps?q=Gangali,+Chhutmalpur,+Saharanpur,+U.P.+247662&output=embed"
